...
CAPITALS = {  # ISO -> (한글명, lon, lat)
    ...
    "SCT": ("에든버러", -3.19, 55.95),
    "DEU": ("베를린", 13.405, 52.52),
    "MEX": ("멕시코시티", -99.13, 19.43),
    "IDN": ("자카르타", 106.845, -6.208),
...
COUNTRIES = {
    ...
    "usa": {
        "iso": "USA",
        "neighbors": [],
        "ratio": "본토 기준 한국의 약 80배",
        "poi": {
            "cities": [("뉴욕", -74.006, 40.713), ("로스앤젤레스", -118.244, 34.052),
                       ("시카고", -87.630, 41.878)],
        },
    },
    "egypt": {
        "iso": "EGY",
        "neighbors": ["LBY", "SDN", "ISR"],
        "ratio": "한국의 약 10배",
        "poi": {
            "cities": [("알렉산드리아", 29.919, 31.200)],
            "spots": [("기자 피라미드", 31.132, 29.979), ("룩소르", 32.640, 25.687)],
            "rivers": [("나일강", [(32.90, 24.09), (32.64, 25.69), (31.18, 27.18),
    ...
    "curacao": {"iso": "CUW", "neighbors": [], "ratio": "서울보다 작은 섬",
                "scenes": ["C", "D"], "smaller": True},
    "germany": {"iso": "DEU", "neighbors": [], "ratio": "한국의 약 3.5배",
                "poi": {"cities": [("뮌헨", 11.58, 48.14), ("함부르크", 9.99, 53.55)]}},
    "mexico": {"iso": "MEX", "neighbors": [], "ratio": "한국의 약 20배",
               "poi": {"cities": [("과달라하라", -103.35, 20.66), ("몬테레이", -100.32, 25.69),
                                  ("칸쿤", -86.85, 21.16)]}},
    "indonesia": {"iso": "IDN", "neighbors": [], "ratio": "한국의 약 19배",
                  "poi": {"cities": [("수라바야", 112.75, -7.25), ("발리(덴파사르)", 115.19, -8.65)]}},
}
